...
1. **State Preservation:** Maintain an array/hash map `freq` to trace the absolute occurrences of every character.
2. **Order Preservation:** Maintain a queue $Q$ to store characters strictly in the order they emerge in the stream.
3. **Execution Loop:** As a character $C$ arrives:
