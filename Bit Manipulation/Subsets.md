---
type: concept
tags: [bit-manipulation, cpp, subsets, combinatorics, math]
date: 2026-06-30
---
...
1. Express $K$ in its $N$-bit binary representation.
2. If the $j$-th bit of $K$ is set to $1$, the element `nums[j]` is strictly included in the corresponding subset.
3. If the $j$-th bit is $0$, the element is excluded.
