---
type: concept
tags: [sorting, cpp, wave-array, local-optimization]
date: 2026-07-01
---
# Wave Form
...
1. If $A[i]$ is smaller than its left neighbor $A[i-1]$, swap them.
2. If $A[i]$ is smaller than its right neighbor $A[i+1]$, swap them.
