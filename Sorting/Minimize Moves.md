...
- algorithm:
- apply [[Sorting]] to the array to deterministically find the median.
- the median is located at index $\lfloor N / 2 \rfloor$.
- compute the sum of $|nums[i] - \text{median}|$ for all elements.
