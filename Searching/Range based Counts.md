---
type: concept
tags: [searching, binary search, cpp, intervals]
date: 2026-06-30
---
# Range Based Counts
...
1. **Start Boundary:** We need the index of the first element $\ge L$. This is strictly the mathematical `lower_bound`.
2. **End Boundary:** We need the index of the first element $> R$. This is strictly the mathematical `upper_bound`.
3. The count of elements falling in $[L, R]$ is precisely the difference between the two indices.
