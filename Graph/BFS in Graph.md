...
- **state Initialization:** Instantiate a dynamic Queue data structure and a boolean array `visited` of size $|V|$, initially all `false`.
- **source Seeding:** Enqueue the origin vertex $S$ and mark `visited[S] = true`.
- **radial Expansion:**
