...
- a **Max-Heap (Priority Queue)** storing the absolute frequencies of all topologically valid tasks.
- a **Cooldown Queue** simulating the strict temporal timeline, storing a tuple `{remaining_frequency, unlock_time}`.
