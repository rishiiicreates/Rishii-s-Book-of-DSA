...
- **structural Invariant (Complete Binary Tree):** Every hierarchical level of the tree must be fully populated with nodes, with the strict exception of the lowest level, which must be populated contiguous from left to right.
- **order Invariant (Heap Property):**
