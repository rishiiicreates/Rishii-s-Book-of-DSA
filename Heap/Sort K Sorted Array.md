...
- **window Initialization:** Load the first $K+1$ elements of the array into a Min Heap.
...
- **flushing:** Once the input array is fully consumed, sequentially pop and place the remaining $K$ elements from the heap into the output array.
