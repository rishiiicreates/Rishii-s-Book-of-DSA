...
### Example Walkthrough
- find $\text{GCD}(48, 18)$:
- $\text{GCD}(48, 18) \implies 48 \pmod{18} = 12 \implies$ Next step: $\text{GCD}(18, 12)$
- $\text{GCD}(18, 12) \implies 18 \pmod{12} = 6 \implies$ Next step: $\text{GCD}(12, 6)$
- $\text{GCD}(12, 6) \implies 12 \pmod 6 = 0 \implies$ Next step: $\text{GCD}(6, 0)$
- base case hit ($B = 0$). Answer is $6$.
