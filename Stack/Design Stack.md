...
- `main Stack`: Stores the absolute input scalars sequentially.
- `min Stack`: Stores the mathematical prefix minimum bound up to the corresponding depth of the main stack.
