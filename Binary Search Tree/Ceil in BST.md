---
type: concept
tags: [binary-search-tree, math, cpp]
date: 2026-06-30
---
...
1. **State Tracking:** Initialize a scalar `ceil_val = -1`.
2. **Iterative Traversal:** Begin at the `root`.
3. **Partition Logic:**
...
4. **Termination:** When `node` evaluates to `nullptr`, return the final recorded `ceil_val`.
