...
- algorithm:
- initialize a `successor` tracker theoretically at null.
...
- the terminating temporal state of `successor` universally perfectly evaluates to the exact tightest upper bound.
